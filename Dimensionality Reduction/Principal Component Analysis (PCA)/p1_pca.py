# -*- coding: utf-8 -*-
"""
Created on Thu Jul 11 23:24:12 2019
...
pca = PCA(n_components = 2) # in first n_components = None takes none because in initially we want to see that which column or variance is effective so we use this in explianed variance ratio
X_train = pca.fit_transform(X_train)
X_test = pca.fit_transform(X_test)
explained_variance = pca.explained_variance_ratio_ # this gives the pca prencentage ratio of each column which column is more influence but when we have n_components = None
